...
function LeftBar() {
  ...
  useEffect(() => {
    const getPost = async () => {
      const getPostUrl = `http://localhost:5000/api/user/flw/${id}`;
      try {
      ...
      <div className="leftbar">
        <div className="NotificationContainer">
          ...
          <div className="notification">
            ...
            <p className="notificationContent">Rajat commented on your post</p>
            <img src={`${image1}`} className="likeImage" alt="" />
          </div>

          <div className="notification">
            <img src={`${image}`} className="notificationImg" alt="" />
            <p className="notificationContent">Rajat Liked your post</p>
            <img src={`${image1}`} className="likeImage" alt="" />
          </div>
